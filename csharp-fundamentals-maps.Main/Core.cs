...
namespace csharp_fundamentals_maps.Main
{
     ...
     */
         ...
         */
         ...
         {
            if (dictionary.ContainsKey(isitthere)) { return true; }
            return false;
        ...
        {
            if (dictionary.ContainsKey(isitthere)) { return dictionary[isitthere]; }
            return -1;
        ...
        public List<string> buildSecretPhrase(int[] numbers)
        {
            ...
            {
                if (map.ContainsKey(number)) { results.Add(map[number]); }
            }
