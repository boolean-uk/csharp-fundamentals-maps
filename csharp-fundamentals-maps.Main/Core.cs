...
namespace csharp_fundamentals_maps.Main
{
     ...
     */
        ...
        {
            Dictionary<string,string> result =createPerson();
         ...
         */
         public bool hasKey(Dictionary<string,string> dictionary, string isitthere)
         {
            ...
            return dictionary.Any(x => x.Key == isitthere);
         }
        ...
        {
            bool isitHere = dictionary.Any(x => x.Key == isitthere);
            if (isitHere) 
            {
                int result = dictionary[isitthere];
                return result;
            }
            else
            {
